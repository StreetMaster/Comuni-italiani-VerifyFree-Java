package demoverifyfreews;

import java.awt.SystemColor;
import streetmaster.verifyfreews.*;
  ...
  *     http://streetmaster.streetmaster.it/smws/verify_free?wsdl
  *     
...
public class FormDemoVerifyFree extends javax.swing.JFrame {
    ...
    private TotOutFree totOutFree=null;
    /**
    ...
    private void jBtnCallVerifyFreeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCallVerifyFreeActionPerformed
        ...
        VerifyFree_Service verifyFreeWS=new VerifyFree_Service();   
        VerifyFree verifyFreeClient= verifyFreeWS.getVerifyFreePort();
       
        // valorizzazione input
        InputVerifyFree inVerifyFree=new InputVerifyFree();
        inVerifyFree.setLocalita(jTxtComuneIn.getText());
        inVerifyFree.setProvincia(jTxtProvIn.getText());
        inVerifyFree.setCap(this.jTxtCAPIn.getText());
        
        // chiamata al servizio
        totOutFree=verifyFreeClient.verifyFree(inVerifyFree, jTxtKey.getText());
        
        // lettura campi generali del risultato
        jTxtEsito.setText(String.valueOf(totOutFree.getNorm()));
        jTxtCodErr.setText(String.valueOf(totOutFree.getCodErr()));
        jTxtNumCand.setText(String.valueOf(totOutFree.getNumCand()));
        curCand=0;
        ...
        if (totOutFree.getNumCand()>0)
        {
            jTxtComuneOut.setText(totOutFree.getOutItem().get(curCand).getComune());
            jTxtProvOut.setText(totOutFree.getOutItem().get(curCand).getProvincia());
            jTxtCAPOut.setText(totOutFree.getOutItem().get(curCand).getCap());
            jTxtFrazioneOut.setText(totOutFree.getOutItem().get(curCand).getFrazione());
        }
    ...
    private void jBtnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnNextActionPerformed
        ...
        if (curCand<totOutFree.getNumCand()-1)
        {
            curCand+=1;
            jTxtComuneOut.setText(totOutFree.getOutItem().get(curCand).getComune());
            jTxtProvOut.setText(totOutFree.getOutItem().get(curCand).getProvincia());
